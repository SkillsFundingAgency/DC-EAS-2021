...
{
    public class ViolationReport : AbstractReportBuilder
    {
        private readonly IKeyValuePersistenceService _storage;

        public ViolationReport(IDateTimeProvider dateTimeProvider,
            [KeyFilter(PersistenceStorageKeys.AzureStorage)] IKeyValuePersistenceService storage) : base(dateTimeProvider)
        {
            _storage = storage;
