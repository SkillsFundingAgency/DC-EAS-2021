...
USING (VALUES		
	...
	(N'FundingLine_03',N'E',N'The CalendarMonth/Year you have submitted data for is outside the start and end dates for the contract associated with this FundingLine.',N'E'),
	...
	(N'DevolvedAreaSourceOfFunding_04',N'W',N'There must be a valid contract between the provider and the specified MCA/GLA (based on DevolvedAreaSourceOfFunding).',N'W'),
