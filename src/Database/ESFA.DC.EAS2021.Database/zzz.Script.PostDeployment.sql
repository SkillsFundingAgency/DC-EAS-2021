...
ALTER ROLE [db_datareader] DROP MEMBER [EAS2021_RO_User];
GO
ALTER ROLE [db_datareader] DROP MEMBER [EAS2021_RW_User];
GO
ALTER ROLE [db_datawriter] DROP MEMBER [EAS2021_RW_User];
GO

RAISERROR('		       RO User',10,1) WITH NOWAIT;
ALTER USER [EAS2021_RO_User] WITH PASSWORD = N'$(ROUserPassword)';
GO
RAISERROR('		       RW User',10,1) WITH NOWAIT;
ALTER USER [EAS2021_RW_User] WITH PASSWORD = N'$(RWUserPassword)';
GO
