...
USING (VALUES		
	...
	(N'CalendarYear_01',N'E',N'''CalendarYear'' is wrong. It must either be 2019 or 2020. Please check the CalendarYear field.',N'E'),
	...
	(N'CalendarYearCalendarMonth_02',N'E',N'''CalendarMonth'' and/or ''CalendarYear'' is wrong. The month/year aren''t in this academic funding year. Please check you''ve entered the correct CalendarMonth and CalendarYear for when the activity you''re claiming for happened. The current funding year spans from 2019-08 to 2020-07.',N'E'),
